$(document).ready(function(){
 ...
 var match = Math.floor(Math.random()*3);
        ...
        $('body').append("<img class=\"front " + lettercount + "\"src=\"images\/" + letter + match + ".png\">");
          console.log(letter + Math.floor(Math.random()*3) + ".png")

        $('body').append("<img class=\"back " + lettercount + "\"src=\"images\/" + letter + match + "back.png\">");
        console.log(letter + match + "back.png")
  ...
  Mousetrap.bind('space', function() {
      lettercount++;
      $('body').append("<img style=\"visibility:hidden;\" class=\"" + lettercount + "\" src=\"images\/e2.png\">");
  });
